    ...
    <div class="container body">
      <div class="main_container">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> 学生管理 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li>
                        <a href="${path}/user/stu.jsp" target="win">主页面</a>
                      </li>

                      <li>
                        <a href="${path}/user/stuAdd.jsp" target="win">新增学员</a>
                      </li>
                      <li>
                        <a href="${path}/user/stuview.jsp" target="win">数据图</a>
                      </li>
                    </ul>
                  </li>
                  ...
                  <li><a><i class="fa fa-edit"></i> 老师管理 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li>
                        <a href="${path}/user/teach.jsp" target="win">主页面</a>
                      </li>

                      <li>
                        <a href="${path}/user/teachAdd.jsp" target="win">新增老师</a>
                      </li>
                      <li>
                        <a href="${path}/user/TeachUpload.jsp" target="win">excel导入教师数据</a>
                      </li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-desktop"></i>管理员 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li>
                        <a href="${path}/user/admin.jsp" target="win">主页面</a>
                      </li>

                      <li>
                        <a href="${path}/user/adminAdd.jsp" target="win">新增管理员</a>
                      </li>
                    </ul>
                  </li>
                  </c:if>
        ...
        <div class="right_col row" role="main">
          <iframe name="win" id="iFrame" class="flexiframe" src="${path}/user/stuview.jsp" style="padding: 0;width:100%;" marginwidth="0" frameborder="no" scrolling="no"
