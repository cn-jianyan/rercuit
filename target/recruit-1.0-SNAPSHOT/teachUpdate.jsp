...
<body>
<form class="needs-validation  mt-4" action="${pageContext.request.contextPath}/teacher/update" method="post" novalidate>

    <input type="hidden" name="tid" id="" value="${teach.tid}" />
    <div class="form-row">
        <div class="form-group col-md-6">
            <label for="inputEmail4">姓名</label>
            <input type="text" class="form-control"name="name" value="${teach.name}"  id="inputEmail4">
        </div>

        <div class="form-group  col-md-6">
            <label for="inlineFormCustomSelect">性别</label>
            <select class="form-control" name="sex" id="inlineFormCustomSelect">
                <option  value="男" <c:if test="${teach.sex=='男'}">checked</c:if> >男</option>
                <option value="女"<c:if test="${teach.sex=='女'}">checked</c:if> >女</option>
            </select>
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" value="${teach.loginname}" readonly name="loginname" id="inputPassword4">
        </div>
        <div class="form-group col-md-6">
            <label >密码</label>
            <input type="text" class="form-control"  value="${teach.loginpwd}"  name="loginpwd" >
        </div>
        <div class="form-group col-md-6">
            <label >招生地区</label>
            <input type="text" class="form-control" value="${teach.area}"  name="area" >
        </div>
        <div class="form-group col-md-6">
            <label >手机</label>
            <input type="number" class="form-control"  value="${teach.phonenum}"  name="phonenum" >
        </div>
        <div class="form-group col-md-6">
            <label >qq</label>
            <input type="number" class="form-control"  value="${teach.qqnum}"  name="qqnum" >
        </div>
        <div class="col-12">
